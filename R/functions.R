...
#' Build a package to work with the NOAA Significant Earthquakes dataset
#' Erik Rehnberg Steeb
#' erehnber@tepper.cmu.edu

#'Documentation at https://github.com/esteeb/RProgCapstone
...
#' @param .data is the dataframe that contains location names written in upper case
...
#' @title Function that will use the GeomTimeLine Prototype Function required to Plot a Timeline with the Earthquakes of a given country
#' @name geom_timeline
...
#' filename<-system.file("data","earthquakes_data.txt.zip",package="capstone")
#' eq_location_clean(eq_clean_data(eq_data_read(filename))) %>%
#' dplyr::filter(datetime >= "1980-01-01"
#' & datetime <="2014-01-01"
